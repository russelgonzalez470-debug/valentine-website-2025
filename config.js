...
const CONFIG = {
    ...
    questions: {
        first: {
            ...
            secretAnswer: "yes, I di dead up fi you babes 😏"           // Secret hover message
        },
        second: {
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dl8daidfy/video/upload/v1769747818/I_Wanna_Be_Yours_kow0m9.mp3", // Music streaming URL
